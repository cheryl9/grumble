...
('How do I connect my Telegram account?', 'Go to Profile → scroll down to Telegram Integration → tap Connect Telegram. Enter your Telegram Chat ID from @GrumblyGrumbot.', 'account', 3, true),
