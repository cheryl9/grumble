...
router.post(
  "/telegram/connect",
  authMiddleware,
  authController.connectTelegram,
);
router.post(
  "/telegram/disconnect",
  authMiddleware,
  authController.disconnectTelegram,
);
...
router.put("/preferences", authMiddleware, authController.savePreferences);
...
router.put(
  "/achievements/equip",
  authMiddleware,
  authController.equipAvatarController,
);
