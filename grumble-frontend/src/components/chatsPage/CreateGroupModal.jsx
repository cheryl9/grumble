  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-2">Add Friends</p>
        <div className="space-y-1 max-h-48 overflow-y-auto mb-4">
          {mockFriends.map(f => (
            ...
            >
              ...
              <span className="text-sm font-semibold text-gray-800 flex-1 text-left">{f.name}</span>
